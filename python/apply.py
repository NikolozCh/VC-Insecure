...
from python.core._numba.executor import generate_apply_looper
...
class FrameRowApply(FrameApply):
    ...
    def generate_numba_apply_func(
        ...
        from python.core._numba.extensions import maybe_cast_str
    ...
    def apply_with_numba(self) -> dict[int, Any]:
        ...
        from python.core._numba.extensions import set_numba_data
