...
from python.core.dtypes.astype import (
    astype_array_safe,
    astype_is_view,
)
...
from python.core.array_algos.putmask import (
    extract_bool_array,
    putmask_inplace,
...
from python.core.array_algos.quantile import quantile_compat
from python.core.array_algos.replace import (
    compare_or_regex_search,
    replace_regex,
    should_use_regex,
)
from python.core.array_algos.transforms import shift
