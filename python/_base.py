...
class ExcelFile:
    ...
    from python.io.excel._calamine import CalamineReader
    from python.io.excel._odfreader import ODFReader
    from python.io.excel._openpyxl import OpenpyxlReader
    from python.io.excel._pyxlsb import PyxlsbReader
    from python.io.excel._xlrd import XlrdReader
